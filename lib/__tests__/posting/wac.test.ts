...
describe("computeWac — pure unit tests", () => {
  ...
  /**
   * 7.00R16 Everton — FREE receipt pulls the average down
   * Buy 2 @ 9,500 (paid), then receive 2 @ 0 (FREE) → WAC = 4,750
   */
  it("7.00R16 Everton with FREE receipt → WAC 4,750.00", () => {
    ...
    // (2×9500 + 2×0) / 4 = 19000 / 4 = 4750
    expect(d2(step2.wac)).toBe("4750.00");
  });
